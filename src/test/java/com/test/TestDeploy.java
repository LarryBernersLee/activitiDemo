...
public class TestDeploy extends BaseTestCase {
	@Resource
	...
	public void testDeploy() throws IOException {
		...
		// 发布流程
		Deployment deployment = repositoryService.createDeployment().addInputStream("Import-video-audit.bpmn", is)
				.name("myvideo1").deploy();
	...
	public InputStream readXmlFile() throws IOException {
		String filePath = "Import-video-audit.bpmn";
